...
local notation a # b := PMap.get b a
...
(nextblock : block)
(access_max : ∀ b ofs, perm_order'' (mem_access#b ofs Max) (mem_access#b ofs Cur))
(nextblock_noaccess : ∀ b ofs k, ~(Plt b nextblock) -> mem_access#b ofs k = None)
...
lemma mkmem_ext:
 forall cont1 cont2 acc1 acc2 next1 next2 a1 a2 b1 b2 c1 c2,
  ...
  mem.mk cont1 acc1 next1 a1 b1 c1 = mkmem cont2 acc2 next2 a2 b2 c2.
Proof.
